...
| If the engine is running, and the user selects: LOW, Windshield moves at a rate of 30rpm |Pass |OFF position is 0 on the potentiometer, ON position is anything past 0.66 on potentiometer. 
